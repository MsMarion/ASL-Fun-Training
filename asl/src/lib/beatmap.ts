...
export const NOTE_LATE_GRACE = 0.4;      // Grace period after target time for late hits (400ms)
export const NOTE_TRACKING_WINDOW = 0.8; // When to start tracking for hits (800ms before target)
