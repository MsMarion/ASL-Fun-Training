...
export function TopHUD() {
  ...
  return (
    <motion.header
      ...
      className="absolute top-6 left-8 right-8 z-50 flex items-center justify-between pointer-events-none"
    >
      ...
      {/* Center: Frosted Level & Stats HUD (Hidden on Home screen for cleanliness) */}
      {pathname !== "/" && (
        <div className="pointer-events-auto flex items-center gap-6 px-8 py-2.5 backdrop-blur-xl bg-black/40 border border-white/10 rounded-2xl shadow-[0_8px_32px_0_rgba(146,0,255,0.25)]">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-sm tracking-wider text-fuchsia-200 uppercase">
              MASTER
            </span>
          </div>
          ...
          <div className="flex items-center gap-2 font-mono text-cyan-300 font-bold text-sm shadow-sm">
