  ...
  return (
    <div className="relative">
      ...
      >
        <CarouselContent className="py-8">
          {songs.map((song) => (
            <CarouselItem key={song.id} className="md:basis-1/2 lg:basis-1/3">
              <div className="p-4">
                <Card 
                  className="group border-4 border-white bg-gradient-to-br from-purple-600 to-pink-600 
                ...
                >
                  <CardContent className="p-6">
                    <div className="aspect-square relative mb-4 rounded-lg overflow-hidden bg-white/10 
                                    border-2 border-white/50 group-hover:border-cyan-400 
                    ...
                    <div className="mt-4 bg-white/20 rounded-full py-2 px-4 text-center border-2 border-white
                                    transition-all duration-300
        ...
        <CarouselPrevious className="bg-purple-600 hover:bg-purple-700 text-white border-4 border-white 
                                     w-20 h-20 -left-10 transition-all duration-300
                                     hover:scale-110 hover:shadow-[0_0_30px_rgba(45,226,230,0.8)]
                                     hover:border-cyan-400" />
        <CarouselNext className="bg-purple-600 hover:bg-purple-700 text-white border-4 border-white 
